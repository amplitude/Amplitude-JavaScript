...
```html
  ...
  <script>
    require(['https://d24n15hnbwhuhn.cloudfront.net/libs/amplitude-3.0.2-min.gz.js'], function(amplitude) {
...
```html
  ...
  <script>
    requirejs.config({
      paths: {
        'amplitude': 'https://d24n15hnbwhuhn.cloudfront.net/libs/amplitude-3.0.2-min.gz'
      }
    });
