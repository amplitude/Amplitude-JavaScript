(function (global, factory) {
  ...
  var strictUriEncode = /*#__PURE__*/Object.freeze({
  ...
  */
  ...
  var decodeUriComponent = /*#__PURE__*/Object.freeze({

  });

  var strictUriEncode$1 = getCjsExportFromNamespace(strictUriEncode);

  var objectAssign$1 = getCjsExportFromNamespace(objectAssign);

  var decodeComponent = getCjsExportFromNamespace(decodeUriComponent);
  ...
  function encode(value, opts) {
  	if (opts.encode) {
  		return opts.strict ? strictUriEncode$1(value) : encodeURIComponent(value);
  	}
  ...
  */
  ...
  AmplitudeClient.prototype._trackParamsAndReferrer = function _trackParamsAndReferrer() {
    ...
    if (this.options.logAttributionCapturedEvent) {
      var attributionProperties = _objectSpread({}, utmProperties, referrerProperties, gclidProperties);
