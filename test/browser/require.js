  ...
  function ma(b) {
    ...
    function I() {
      ...
      if (!ba) {
        ...
        if (c && f.length)
          return (a = G('timeout', 'Load timeout for modules: ' + f, null, f)), (a.contextName = h.contextName), B(a);
        g &&
          x(l, function (a) {
            K(a, {}, {});
          });
    ...
    h = {
      ...
      onScriptError: function (a) {
        ...
        if (!p(b.id)) {
          ...
          return B(
            G('scripterror', 'Script error for "' + b.id + (c.length ? '", needed by: ' + c.join(', ') : '"'), a, [
              b.id,
            ]),
          );
        }
  ...
  if ('undefined' === typeof define) {
    ...
    k.load = function (b, c, d) {
      ...
      if (F) {
        ...
        !e.attachEvent || (e.attachEvent.toString && 0 > e.attachEvent.toString().indexOf('[native code')) || da
      ...
      Y(document.getElementsByTagName('script'), function (b) {
        ...
        if ((P = b.getAttribute('data-main')))
          return (
            (u = P),
            v.baseUrl ||
              ((J = u.split('/')), (u = J.pop()), (U = J.length ? J.join('/') + '/' : './'), (v.baseUrl = U)),
            (u = u.replace(V, '')),
    ...
    define = function (b, c, d) {
      ...
      T &&
        (g = Q || pa()) &&
        (b || (b = g.getAttribute('data-requiremodule')), (e = K[g.getAttribute('data-requirecontext')]));
