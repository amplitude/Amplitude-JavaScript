...
describe('Amplitude', function () {
  ...
  describe('getInstance', function () {
    ...
    it('instances should have separate event queues and settings', function () {
      ...
      assert.deepEqual(JSON.parse(localStorage.getItem('amplitude_unsent_' + apiKey))[0].event_type, 'amplitude event');
      assert.deepEqual(
        JSON.parse(localStorage.getItem('amplitude_unsent_' + apiKey))[1].event_type,
        'amplitude event2',
      );
      ...
      assert.deepEqual(JSON.parse(localStorage.getItem('amplitude_unsent_identify_1_app1'))[0].user_properties, {
        $set: { key: 'value' },
      });
      assert.equal(JSON.parse(localStorage.getItem('amplitude_unsent_2_app2'))[0].event_type, 'app2 event');
  ...
  describe('init', function () {
    ...
    it('should load saved events from localStorage', function () {
      ...
      assert.deepEqual(
        amplitude2.getInstance()._unsentIdentifys.map(({ event }) => event),
